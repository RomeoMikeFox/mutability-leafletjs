...
PlaneObject.prototype.updateIcon = function() {
	...
	// match the info window alert color.
        ...
        if (ShowAircraftIcon) {
			...
			this.icon.rotationAngle = rotation;
		}
